...
from network.optim import *
from network.activ import *
from network.loader.data_loader import *
...
def small_network_sgd():
    ...
    #  
    # accuracy on train:                                      80.39%                   (overfitting on test)
    # accuracy on valid:                                       79.83%          (overfitting on valid as we keep nudging)
    # accuracy on test:                                        55.32%                    ^ more interesting
    #
    # best model @ epoch 57                               
